...
const PRODUCTS = [
    ...
    {"id": 3, "category": "spicy_herbs", "name": "Мелиса \"Турецкая\"", "price": 250, "weight": "1 лоток (10x15 см)", "growth_min": 40, "growth_max": 45, "img": demoImages[0], "images": demoImages, "description": "Восточная сказка с прохладными мятными нотками. Успокаивает и придает блюдам неповторимый шарм.\n\nИдеально для:\n✨ Напитков и коктейлей\n✨ Фруктовых салатов\n\nАроматно и свежо🌱"},
    ...
    {"id": 5, "category": "spicy_herbs", "name": "Базилик \"Маргарет\"", "price": 250, "weight": "1 лоток (10x15 см)", "growth_min": 40, "growth_max": 45, "img": demoImages[0], "images": demoImages, "description": "Сладкий, насыщенный и невероятно ароматный. Настоящая находка для гурманов!\n\nИдеально для:\n✨ Мясных блюд\n✨ Соусов и маринадов\n\nСочно и вкусно🥩"},
    {"id": 6, "category": "spicy_herbs", "name": "Базилик \"Итальянский лимонный\"", "price": 250, "weight": "1 лоток (10x15 см)", "growth_min": 40, "growth_max": 45, "img": demoImages[0], "images": demoImages, "description": "Микс пряного базилика и яркой цитрусовой цедры. Необычное сочетание, которое удивляет!\n\nИдеально для:\n✨ Запеченной рыбы и морепродуктов\n✨ Летних салатов\n\nДерзко и цитрусово🐟"},
    ...
    {"id": 10, "category": "salads", "name": "Салат \"Вишневая дымка - мини\"", "price": 250, "weight": "1 лоток (10x15 см)", "growth_min": 40, "growth_max": 45, "img": demoImages[0], "images": demoImages, "description": "Нежнейшие хрустящие листочки с мягким вкусом. Идеальная база для любого блюда!\n\nИдеально для:\n✨ Легких салатов\n✨ Сэндвичей и бургеров\n\nСвежо и хрустяще🥪"},
